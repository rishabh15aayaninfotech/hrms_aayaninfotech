...
<body>
                    ...
                    <div class="d-flex my-xl-auto right-content align-items-center flex-wrap ">
                        <div class="me-2 mb-2">
                            <div class="d-flex align-items-center border bg-white rounded p-1 me-2 icon-list">
                                ...
                                <a href="#"
                                    class="btn btn-icon btn-sm"><i class="ti ti-calendar-event"></i></a>
                            </div>
                        </div>
                        <div class="me-2 mb-2">
                            <div class="dropdown">
                            ...
                            <table class="table datatable">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td>
                                            <span
                                                class="badge badge-success-transparent d-inline-flex align-items-center">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <span
                                                class="badge badge-danger-transparent d-inline-flex align-items-center">
    ...
    <script src="https://smarthr.dreamstechnologies.com/html/template/assets/js/jquery-3.7.1.min.js"
        type="f75a1712c86381b804fe1e5b-text/javascript"></script>
    ...
    <!-- Custom JS -->
    <script src="https://smarthr.dreamstechnologies.com/html/template/assets/js/circle-progress.js"
        type="f75a1712c86381b804fe1e5b-text/javascript"></script>
    ...
    <script src="https://smarthr.dreamstechnologies.com/cdn-cgi/scripts/7d0fa10a/cloudflare-static/rocket-loader.min.js"
        data-cf-settings="f75a1712c86381b804fe1e5b-|49" defer></script>
    <script defer
