...
<head>
	...
	<title>Aayan Infotech | HRMS | Login</title>
	...
	<!-- Favicon -->
	<link rel="icon" href="assets/img/logo/aayaninfotech_logo.jfif" type="image/x-icon">
	<link rel="shortcut icon" href="assets/img/logo/aayaninfotech_logo.jfif" type="image/x-icon">

	<!-- Theme Script js -->
	<script src="assets/js/theme-script.js" type="05da384fbc2078d81dbf2969-text/javascript"></script>
...
<body class="bg-white">
				...
				<div class="row">
					<div class="col-lg-7">
						<div
							...
							<div>
								<img src="assets/img/login/login-page.jpg" class="img-fluid" alt="Img">
							</div>
						</div>
					</div>
									...
									<div class="vh-100 d-flex flex-column justify-content-between p-4 pb-0">
										...
										<div class="">
											<div class="text-center mb-3">
												<h2 class="mb-2">Login to HRMS</h2>
											...
											<div class="mb-3">
												<button type="submit" class="btn btn-primary w-100"><a href="admin/admin-dashboard.php" class="text-white text-decoration-none">Sign In to Admin</a></button>
											</div>
                                            <div class="mb-3">
												<button type="submit" class="btn btn-primary w-100"><a href="employee/employee-dashboard.php" class="text-white text-decoration-none">Sign In to Employee</a></button>
											</div>
												...
												<div class="d-flex align-items-center justify-content-center flex-wrap">
													<div class="text-center me-2 flex-fill">
														<a href="javascript:void(0);"
															...
															<img class="img-fluid m-1"
																src="https://smarthr.dreamstechnologies.com/html/template/assets/img/icons/facebook-logo.svg"
																alt="Facebook">
														</a>
													</div>
													<div class="text-center me-2 flex-fill">
														<a href="javascript:void(0);"
															...
															<img class="img-fluid m-1"
																src="https://smarthr.dreamstechnologies.com/html/template/assets/img/icons/google-logo.svg"
																alt="Facebook">
														</a>
													</div>
													<div class="text-center flex-fill">
														<a href="javascript:void(0);"
															...
															<img class="img-fluid m-1"
																src="https://smarthr.dreamstechnologies.com/html/template/assets/img/icons/apple-logo.svg"
																alt="Apple">
														</a>
													</div>
												</div>
										...
										<div class="mt-5 pb-4 text-center">
											<p class="mb-0 text-gray-9">Copyright &copy; 2026 - Aayan Infotech</p>
										</div>
									</div>
								</form>
							</div>
	...
	<!-- jQuery -->
	<script src="assets/js/jquery-3.7.1.min.js" type="7970e9ca2a097f42928a7ce6-text/javascript"></script>

	<!-- Bootstrap Core JS -->
	<script src="assets/js/bootstrap.bundle.min.js" type="7970e9ca2a097f42928a7ce6-text/javascript"></script>

	<!-- Feather Icon JS -->
	<script src="assets/js/feather.min.js" type="7970e9ca2a097f42928a7ce6-text/javascript"></script>

	<!-- Custom JS -->
	<script src="assets/js/script.js" type="7970e9ca2a097f42928a7ce6-text/javascript"></script>

	<script src="https://smarthr.dreamstechnologies.com/cdn-cgi/scripts/7d0fa10a/cloudflare-static/rocket-loader.min.js"
		data-cf-settings="7970e9ca2a097f42928a7ce6-|49" defer></script>
	<script defer
